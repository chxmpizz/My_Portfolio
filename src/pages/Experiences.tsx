  ...
  return (
    ...
    >
      ...
      className="flex flex-col  items-center w-5/6 rounded-2xl border-2 border-white mt-10 py-10 px-5">
        <div className=" flex justify-between max-md:flex-col max-md:justify-center items-center w-full">
          <div className="flex items-center max-md:flex-col">
            <img
              ...
              height={60}
            />
            <p className="ml-4 text-2xl max-md:text-xl">
              Internship at{" "}
              <motion.div 
              ...
              className='inline-block rounded-xl p-0.5'>
                <div className='bg-black rounded-xl p-1'>
                  ...
                  className="
                  text-3xl bg-gradient-to-r max-md:text-xl from-[#61A2C6] via-[#263B6D] to-[#EF8673] bg-clip-text text-transparent">
                    Mee Solution
                  </a>
                </div>
              </motion.div>
          ...
          <p className="text-2xl text-gray-400 max-md:text-xl">June - Aug 2025</p>
        </div>
        <div className="mt-4">
          <p className="text-xl max-md:text-lg text-start font-normal">
